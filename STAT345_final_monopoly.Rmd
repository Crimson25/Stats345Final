...
#Visualizion: Count
frequency_frame <- as.data.frame(spot_frequency) 
frequency_frame <- frequency_frame %>% pivot_longer(1:40)
frequency_frame
frequency_frame$name <- factor(frequency_frame$name, levels = frequency_frame$name)
ggplot(frequency_frame, aes(name, value)) + geom_col() + labs(title = "Space Frequency", x = "Space", y  = "Frequency") + theme(axis.text.x = element_text(angle = 90))
