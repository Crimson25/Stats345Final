...
frequency_data <- data.frame(spot_frequency) 
#flips data
frequency_data <- t(frequency_data)


frequency_data <- data.frame(space = 1:40, count = frequency)

ggplot(frequency_data, aes(space, frequency)) + geom_col()
```
